...
# Endpoint and auth
ENDPOINT="http://localhost:8000/hackrx/run"
AUTH_TOKEN="Bearer 8915ddf1d1760f2b6a3b027c6fa7b16d2d87a042c41452f49a1d43b3cfa6245b"

# Helper: send one request with a here-doc JSON payload
send_request() {
...
# 3) UNI GROUP HEALTH INSURANCE POLICY
curl -sS -X POST "$ENDPOINT" \
  -H "Content-Type: application/json" \
  -H "Authorization: $AUTH_TOKEN" \
  -d @- <<'EOF'
